...
class HttpUtilTest {
  ...
  /**
   * GET 요청 테스트_URL에서 포스트를 가져와서 ID를 확인
   */
  @Order(1)
  @DisplayName("GET 요청 테스트_URL에서 포스트를 가져와서 ID를 확인")
  @Test
  ...
  /**
   * POST 요청 테스트_새로운 포스트를 생성하여 응답의 title과 body를 확인
   */
  @Order(2)
  @DisplayName("POST 요청 테스트_새로운 포스트를 생성하여 응답의 title과 body를 확인")
  @Test
  ...
  /**
   * PUT 요청 테스트_기존 포스트를 업데이트하여 응답의 title과 body를 확인
   */
  @Order(3)
  @DisplayName("PUT 요청 테스트_기존 포스트를 업데이트하여 응답의 title과 body를 확인")
  @Test
  ...
  /**
   * PATCH 요청 테스트_기존 포스트의 title을 업데이트하여 응답의 title을 확인
   */
  @Order(4)
  @DisplayName("PATCH 요청 테스트_기존 포스트의 title을 업데이트하여 응답의 title을 확인")
  @Test
  ...
  /**
   * 작성된 HTTP 요청/응답 테스트에 사용되는 PostDTO 클래스.
   */
  @Getter
  @Builder
  @AllArgsConstructor
