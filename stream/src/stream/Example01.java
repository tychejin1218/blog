...
public class Example01 {
  ...
  public static void main(String args[]) {
    ...
    System.out.println("2.Stream 생성 방법 : Stream.builder()");
    createStreamBuilder();

    System.out.println("3.Stream 생성 방법 : Stream.empty()");
    createStreamEmpty();

    System.out.println("4.Stream 생성 방법 : Stream.generate()");
    createStreamGenerate();

    System.out.println("5.Stream 생성 방법 : Stream.iterate()");
    createStreamIterate();

    System.out.println("6.Stream 생성 방법 : List -> Stream");
    createListToStream();

    System.out.println("7.Stream 생성 방법 : Array -> Stream");
    createArrayToStream();
  }
